...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='攻击算法';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户-容器表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='机器学习任务';

INSERT INTO `container`.`role` (id, `desc`, permission_value)
VALUES (1, 'user', 1),
       (2, 'admin', 2);

INSERT INTO `container`.`user` (username, hashed_password, created_at, updated_at, is_delete, email, user_role)
VALUES ('joexu01', '$2a$10$2cuYsP3Wlpc59zV3RWan1.jw8oVj/dxuyoJkBOAu4afwm2CL0xjFq', '2022-07-26 15:45:50.0',
        '2022-07-26 15:45:50.0', 0, 'joexu01@yahoo.com', 2);
